function injectJS() {
    //var iFrameHead = window.frames["keycloak-session-iframe"].contentWindow.document.getElementsByTagName("head")[0];
    //var myscript = document.createElement('script');
    //myscript.type = 'text/javascript';
    //myscript.src = 'Polyfill.js';
    //iFrameHead.appendChild(myscript);
    var iframe = document.getElementById('keycloak-session-iframe');
    //var iframeDoc = iframe.contentDocument || iframeWin.document;
    //iframeDoc.write('\<script type="text/javascript" src="Polyfill.js"><\/script>');
    iframe.contentWindow.postMessage('\<script type="text/javascript" src="Polyfill.js"><\/script>', '*')
}
